          ...
          <div class="row">
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                ...
                $queryValidate = "SELECT id FROM tbl_admin ORDER BY id";
                ...
                ?>
                  ...
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"> <?php echo ''.$row.'' ?> </h3>
            ...
            <div class="col-md-3 grid-margin stretch-card">
              <div class="card">
                ...
                $queryValidate = "SELECT id FROM tbl_employees ORDER BY id";
                $sqlValidate = mysqli_query($connection, $queryValidate);

                $row = mysqli_num_rows($sqlValidate);
                
                ?>
                  <p class="card-title text-md-center text-xl-left"> Registered Employee </p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0"> <?php echo ''.$row.'' ?> </h3>
